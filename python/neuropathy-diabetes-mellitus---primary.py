...
codes = [{"code":"C10EC00","system":"readv2"},{"code":"C108C11","system":"readv2"},{"code":"C109B11","system":"readv2"},{"code":"C106.13","system":"readv2"},{"code":"C10FB11","system":"readv2"},{"code":"F372.00","system":"readv2"},{"code":"F372.11","system":"readv2"},{"code":"C10FB00","system":"readv2"}];
REQUIRED_CODES = 1;
