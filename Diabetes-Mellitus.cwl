...
steps:
  ...
  diabetes-mellitus-monitoring---primary:
    run: diabetes-mellitus-monitoring---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-hypoglycaemia---primary:
    run: diabetes-mellitus-hypoglycaemia---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-monitoring---primary/output
  arthropathy-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-hypoglycaemia---primary/output
  mononeuropathy-diabetes-mellitus---primary:
    run: mononeuropathy-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  ketoacidotic-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: mononeuropathy-diabetes-mellitus---primary/output
  ...
  diabetes-mellitus-pregnancy---primary:
    run: diabetes-mellitus-pregnancy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  retinopathy-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-pregnancy---primary/output
  dietary-diabetes-mellitus---primary:
    run: dietary-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: dietary-diabetes-mellitus---primary/output
  ...
  diabetes-mellitus-community---primary:
    run: diabetes-mellitus-community---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-followup---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-community---primary/output
  ...
  clinic-diabetes-mellitus---primary:
    run: clinic-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-amyotrophy---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: clinic-diabetes-mellitus---primary/output
  ...
  insulindependent-diabetes-mellitus---primary:
    run: insulindependent-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-control---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: insulindependent-diabetes-mellitus---primary/output
  ...
  diabetes-mellitus-cataract---primary:
    run: diabetes-mellitus-cataract---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  moderate-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-cataract---primary/output
  ...
  hospital-diabetes-mellitus---primary:
    run: hospital-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-screening---primary:
    run: diabetes-mellitus-screening---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: hospital-diabetes-mellitus---primary/output
  maculopathy-diabetes-mellitus---primary:
    run: maculopathy-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-screening---primary/output
  diabetes-mellitus-ulcerated---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: maculopathy-diabetes-mellitus---primary/output
  right-diabetes-mellitus---primary:
    run: right-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-background---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: right-diabetes-mellitus---primary/output
  diabetes-mellitus-given---primary:
    run: diabetes-mellitus-given---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-charcot---primary:
    run: diabetes-mellitus-charcot---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-given---primary/output
  diabetes-mellitus-offered---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-charcot---primary/output
  ...
  diabetes-mellitus-attack---primary:
    run: diabetes-mellitus-attack---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  multidisciplinary-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-attack---primary/output
  neuropathic-diabetes-mellitus---primary:
    run: neuropathic-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-month---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: neuropathic-diabetes-mellitus---primary/output
  ...
  diabetes-mellitus-treatment---primary:
    run: diabetes-mellitus-treatment---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  nonketotic-diabetes-mellitus---primary:
    run: nonketotic-diabetes-mellitus---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-treatment---primary/output
  juvenile-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: nonketotic-diabetes-mellitus---primary/output
  diabetes-mellitus-assessment---primary:
    run: diabetes-mellitus-assessment---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-review---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-assessment---primary/output
  ...
  diabetes-mellitus-resolved---primary:
    run: diabetes-mellitus-resolved---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  pancreatic-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-resolved---primary/output
  diabetes-mellitus-dependant---primary:
    run: diabetes-mellitus-dependant---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-counselling---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-dependant---primary/output
  ...
  diabetes-mellitus-nurse---primary:
    run: diabetes-mellitus-nurse---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  hyperosmolar-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-nurse---primary/output
  diabetes-mellitus-excretion---primary:
    run: diabetes-mellitus-excretion---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-programme---primary:
    run: diabetes-mellitus-programme---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-excretion---primary/output
  annual-diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-programme---primary/output
  ...
  diabetes-mellitus-liaison---primary:
    run: diabetes-mellitus-liaison---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-gastroparesis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-liaison---primary/output
